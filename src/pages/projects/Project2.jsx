...
const Project2 = () => {
    ...
    const images = imageIds.map((id, idx) => ({
        beforeSrc: `/images/projects/Project_AI_WorkFlow/antes_${id}.png`,
        afterSrc: `/images/projects/Project_AI_WorkFlow/despues_${id}.png`,
            ...
            <div className="min-h-screen pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-10">
                            ...
                            >
                                ...
                                <div className="grid grid-cols-2 gap-px bg-white/5">
                                    <div className="relative group bg-zinc-950 overflow-hidden">
                                        ...
                                        <img
                                            src={`/images/projects/Project_AI_WorkFlow/antes_${id}.png`}
                                    ...
                                    <div className="relative group bg-zinc-950 overflow-hidden">
                                        ...
                                        <img
                                            src={`/images/projects/Project_AI_WorkFlow/despues_${id}.png`}
                ...
                <section className="mt-16 mb-8">
                    ...
                    <div className="rounded-2xl overflow-hidden border border-white/5 bg-zinc-900/40 backdrop-blur-sm shadow-lg">
                        ...
                        <a href="/images/projects/Project_AI_WorkFlow/preview.png" target="_blank" rel="noopener noreferrer" className="block">
                            <img
                                src="/images/projects/Project_AI_WorkFlow/preview.png"
